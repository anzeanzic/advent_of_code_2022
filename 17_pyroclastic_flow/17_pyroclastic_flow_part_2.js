...
const PrintCave = () => {
	const handle = fs.createWriteStream('./output');
...
const cycles = Math.floor((rocks - 15) / 35); // 15 shapes
const remainder = (rocks - 15) % 35;
console.log(remainder, (remainder/35) * 53);
console.log(cycles * 53 + 25 + (remainder/35) * 53); // 25 višine do prvega vzorca, 53 višina vzorca
*/
//1514285714288
//1514285714288
...
// input
const rocks = 1000000000000;
const cycleShapes = 1745;
const cycleHeight = 2778;
const cycles = Math.floor((rocks - 229) / cycleShapes);
const remainder = (rocks - 229) % cycleShapes;
console.log(remainder, Math.round((remainder/1745) * 100)/100 * cycleHeight);
console.log(cycles * cycleHeight + 350 + Math.round((remainder/1745) * 100)/100 * cycleHeight);

// too high -> 1591977078884
//1591977077352
//